...
const UnderConstruction = () => {
  return (
    <div className="h-screen grid content-center justify-items-center">
      <div className="text-center shadow p-20 rounded-xl border group hover:bg-warning hover:duration-700">
        <h2 className="text-8xl font-bold text-error group-hover:text-white">
          <IoMdConstruct className="w-full mx-auto" />
          OOPS!
        </h2>
        ...
        <p className="text-xl mb-3 group-hover:text-white">
          Sorry, the page are you looking for it's an under construction.
        </p>
